      ...
      <div className="max-w-screen-xl mx-auto py-12 px-5" >
        ...
        <div className="flex flex-wrap flex-col md:flex-row justify-between items-center border-b border-gray-700 pb-6">
          ...
          <div className="flex flex-wrap md:space-x-6 gap-4 text-gray-400 text-sm font-medium">
            <a href="https://github.com/Tushar-Dhingra" className="hover:text-white text-lg   ">
              GitHub
            </a>
            <a href="https://www.linkedin.com/in/tushar-dhingra99/" className="hover:text-white text-lg  ">
              Linkedin
            </a>
            <a  href="mailto:tushardhingra808@gmail.com" className="hover:text-white text-lg ">
              Email
            </a>
            <a href="https://x.com/tushardhingraa" className="hover:text-white text-lg ">
              X
            </a>
          </div>
